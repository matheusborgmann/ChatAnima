...
Este é um aplicativo de chat animado.
...
Além do comando `npm run start`, você pode utilizar outros comandos úteis:

- `npm run build`: Compila a aplicação para produção, criando uma versão otimizada para implantação.
